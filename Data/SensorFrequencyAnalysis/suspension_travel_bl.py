...
df = pl.read_parquet('/Users/aanyajain/Documents/GitHub/fs-data/FS-3/01172026/011726-10.parquet')
df = df.fill_null(strategy="forward").fill_null(strategy="backward")
signal = df["TPERIPH_BL_DATA_SUSTRAVEL"].to_numpy()
...
plt.xlabel("Attempt")
plt.ylabel("RMS")
plt.title("Suspension Travel BL - RMS vs Attempt")
plt.show()
...
plt.title("Suspension Travel BL - Frequency Spectrum")
plt.show()
