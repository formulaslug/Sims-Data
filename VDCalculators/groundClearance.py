...
# forces on the front wheels and rear wheels
...
def wheel_displacement(x_spring, motion_ratio):
    return x_spring / motion_ratio**2
...
def compute_ride_height(frontKS, rearKS,
    ...
    kwF = wheel_displacement(frontKS, motionRatioF)
    kwR = wheel_displacement(rearKS, motionRatioR)

    xF = wheel_displacement(frontKS, kwF)
    xR = wheel_displacement(rearKS, kwR)
