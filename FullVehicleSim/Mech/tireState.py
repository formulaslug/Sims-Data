...
class Tire:
    ...
    def getLateralForcePure(self):
        ...
        self.Dy = self.getLateralCoefficientOfFriction() * self.normalForce * (self.magic["tempYAPure"] * self.tireTemperature ** 2 + self.magic["tempYBPure"] * self.tireTemperature + self.magic["tempYCPure"])
    ...
    def getLongForceCombinedSlip(self):
        ...
        #print(fCoefficient)
        return force * min(1,(fCoefficient + self.magic["combined_long_offset"]))
